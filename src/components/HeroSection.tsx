...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-72 h-72 bg-accent/10 rounded-full blur-3xl animate-pulse delay-500" />

      {/* Content */}
      <div className="relative z-40 max-w-6xl mx-auto px-6 lg:px-8 text-center">
        {/* Hero Headline */}
        <div className="mb-8">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-inter leading-tight mb-6">
          ...
          <div className="mx-auto w-32 h-1 bg-gradient-primary rounded-full shadow-glow mb-8" />
        </div>

        {/* Subheading */}
        <p className="text-xl md:text-2xl lg:text-3xl text-muted-foreground font-inter font-light max-w-4xl mx-auto mb-12 leading-relaxed">
